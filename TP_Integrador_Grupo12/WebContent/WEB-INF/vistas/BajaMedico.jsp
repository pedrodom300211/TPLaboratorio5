...
<script>
        function confirmarEliminar() {
            return confirm("¿Estás seguro de que quieres eliminar este Medico?");
        }
    </script>	
</head>
    ...
    <form action="Baja_Medico.html" method="get">
	Bienvenido Admin a Baja Medico<br>
	<h2>Usuario: ${nombreUsuario}</h2>
	
		Ingrese el Legajo del Medico a dar de baja:
		<input type="number" name="txtLegajoBajaMedico" placeholder="00000000">
		<br>
		<input type="submit" name="btnBajaMedico" value="Dar de Baja Medico" onclick="return confirmarEliminar();">
	</body>
</form>
<c:choose>
    <c:when test="${Filas == 1}">
        <p style="color:green;">Medico eliminado con éxito.</p>
    </c:when>
    <c:when test="${Filas == -1}">
